...
(function() {
  $(function() {
    var Class, Events, VERSION, _Sys, _extend;
    VERSION = "BETA 0.2";
    (function() {
      var keyStack, q;
      keyStack = [];
    ...
    Sysweb.Env = (function() {
      ...
      _Env = _Sys.extend({
        ...
        deleteExport: function(path, success) {
          var _this = this;
          if (success == null) {
            success = function() {};
          }
        ...
        loadExports: function(exports) {
          ...
          for (_i = 0, _len = exports.length; _i < _len; _i++) {
            ex = exports[_i];
            _results.push(document.getElementsByTagName('head')[0].appendChild(document.createElement('script')).setAttribute('src', ("/sys_root/" + Sysweb.User.currentUser.username + "/" + ex).replace("//", "/")));
          }
          return _results;
        },
        loadEnv: function(envcb) {
          var _this = this;
          if (envcb == null) {
            envcb = function(env) {};
          }
        ...
        saveEnv: function(env, success, error) {
          ...
          return Sysweb.fs.write(this.ENV_FILE, JSON.stringify(env)).done(function() {
            _this.env = env;
            return success();
          }).fail(function() {
            return fail();
    ...
    return Sysweb.Api = (function() {
      var _Api;
      _Api = Events.extend({
        publish: function(path, appName, version) {
          return console.log(version);
        },
        install: function(appName, version) {
          return console.log(version);
        }
      });
      return new _Api;
